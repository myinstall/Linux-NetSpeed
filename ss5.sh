...
bbr_install() {
    ...
    wget -O tcp.sh --no-check-certificate "https://raw.githubusercontent.com/myinstall/Linux-NetSpeed/master/tcp.sh" && chmod +x tcp.sh && ./tcp.sh
...
# Xray Installation
wget -O /usr/local/bin/socks --no-check-certificate https://raw.githubusercontent.com/myinstall/Linux-NetSpeed/master/socks 
